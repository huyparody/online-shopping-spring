$(function() {
	...
	if ($table.length) {
		...
		$table
				.DataTable({
					...
					lengthMenu : [ [ 3, 5, 10, -1 ],
							[ '3 sản phẩm', '5 sản phẩm', '10 sản phẩm', 'Tất cả' ] ],
					pageLength : 5,
					ajax : {
						url : jsonUrl,
						dataSrc : ''
	...
	if($productsTable.length) {
		...
		$productsTable.DataTable({
					lengthMenu : [ [ 10, 30, 50, -1 ], [ '10 sản phẩm', '30 sản phẩm', '50 sản phẩm', 'Tất cả' ] ],
					pageLength : 30,
					ajax : {
						url : jsonUrl,
						dataSrc : ''
					...
					initComplete: function () {
						...
						api.$('.switch input[type="checkbox"]').on('change' , function() {							
							var dText = (this.checked)? 'Bạn có muốn hiển thị sản phẩm?': 'Bạn có muốn ẩn sản phẩm?';
