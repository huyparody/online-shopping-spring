...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12">
			...
			<ol class="breadcrumb">
				...
				<li><a href="${contextRoot}/show/all/products">Tất cả sản phẩm</a></li>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-8">
			...
			<h4>Giá: <strong>${product.unitPrice} VND</strong></h4>
			<hr/>
			...
			<c:choose>
				...
				<c:when test="${product.quantity < 1}">
					...
					<h6>Số lượng hiện có: <span style="color:red">Hết hàng!</span></h6>
					
				</c:when>
				<c:otherwise>				
					
					<h6>Số lượng hiện có: ${product.quantity}</h6>
