			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manage/product" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label class="control-label col-md-4">Thương hiệu</label>
							<div class="col-md-8">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								...
								<div class="text-right">
									...
									<button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#myCategoryModal">Thêm Danh Mục</button>
								</div>							
							</div>
