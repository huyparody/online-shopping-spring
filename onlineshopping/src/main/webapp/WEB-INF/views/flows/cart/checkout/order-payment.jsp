	...
	<div class="row">
				...
				<div class="row">
					...
					<div class="col-xs-12">
						...
						<div>
							...
							<h5>Buying Price - VND ${cartLine.buyingPrice}/-</h5>							
						</div>						
						<hr/>
						<div class="text-right">
							<h3>Grand Total - VND ${cartLine.total}/-</h3>
						</div>						
					</div>
					</c:forEach>
				</div>
			...
			<div class="col-md-6">
	            ...
	            <ul class="nav nav-pills nav-stacked">
	                <li class="active"><a href="#"><span class="badge pull-right"> VND ${checkoutModel.checkoutTotal}/-</span> Final Payment</a></li>
	            </ul>
	            <br/>
