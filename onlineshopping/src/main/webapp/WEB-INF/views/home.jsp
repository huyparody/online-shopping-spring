			...
			<div class="row carousel-holder">
                ...
                <div class="row is-table-row">
                    ...
                    <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts">                    	
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <a ng-href="${contextRoot}/show/{{product.id}}/product" class="btn btn-primary pull-right">Xem</a>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <h4>Xem thêm các sản phẩm khác</h4>
                        <hr/>
                        <a class="btn btn-primary" href="${contextRoot}/show/all/products">Xem Thêm</a>
                    </div>
